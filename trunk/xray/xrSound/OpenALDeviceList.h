...
#include "..\..\3rd party\OpenAL\Include\al.h"
...
struct ALDeviceDesc{
	...
	ESndProps				props; //Kondr2
						ALDeviceDesc			(LPCSTR nm, int mn, int mj){strcpy(name,nm);minor_ver=mn;major_ver=mj;props.storage=0;props.eax_unwanted=true;}
};
